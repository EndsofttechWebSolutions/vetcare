	...
	<form id="wp_login_form" action="" method="POST">
		<div id="form_right">
          ...
          <div class="input_container"> 
            ...
            <input type="text" name="email" class="input_field" placeholder="Username" value="<?php if(isset($email_set)){ echo $email_set; } ?>" required><br>
        </div>

        <div class="input_container"> 
            <i class="fas fa-lock"></i>
            <input type="password" name="password" class="input_field" placeholder="Password" value="<?php if(isset($pass_set)){ echo $pass_set; } ?>" required>
        </div>
        <input type="submit" id="submitbtn" name="submitlogin" class="input_field">
    </div> 
</form>
</div>