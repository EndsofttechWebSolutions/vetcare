 ...
 <?php if(!is_page(140)){ ?>
  ...
  <body <?php body_class(); ?> id="testbody">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      <a class="navbar-brand" href="<?php echo get_home_url().'/dashboard'; ?>"><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/03/vet-app-icon-removebg-preview-1.png" style="width:26%;"> VETCARE</a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button>
      <!-- Navbar Search-->
